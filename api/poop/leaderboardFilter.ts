...
const leaderboardFilterEndpoint = async function (server: FastifyInstance, options: RouteOptions) {
	server.get('/leaderboard/:year/:month', async (req: FastifyRequest<{Params: Params}>, res: FastifyReply) => {
