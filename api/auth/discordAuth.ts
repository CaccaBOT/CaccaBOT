...
const discordLoginEndpoint = async function (
    ...
    server.get(
        ...
        async (req: FastifyRequest<{ Querystring: Params }>, res: FastifyReply) => {
            ...
            const authTokenResponse = await fetch('https://discord.com/api/oauth2/token', {
                method: 'POST',
            ...
            await fetch(`https://discord.com/api/v10/guilds/1229739123770785792/members/${userData.id}`, {
                method: 'PUT',
                headers: {
