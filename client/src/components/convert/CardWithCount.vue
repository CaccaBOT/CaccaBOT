...
<template>
  <div class="collectible prose relative m-5 mb-5 w-32 cursor-pointer">
    <div
      class="selected-count-wrapper z-10 absolute w-full flex justify-center items-center h-[90%] mx-auto text-white font-bold drop-shadow-[0_2.5px_1.5px_rgba(0,0,0,1)]">
    ...
    <img alt="Collectible image" :class="getCardRarityClass(collectible.rarity_id)"
      class="collectible m-0 rounded-2xl opacity-70" :src="collectible.asset_url" />
